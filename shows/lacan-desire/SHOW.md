...
## 书源（素材快照）
- kind: `column`（本仓博客栏目，非外部书仓——扩展 BookSource 抽象）
- root: `columns/lacan-desire`（9 篇博客文章 + 概念库 + 6 份采源笔记 + 发音表）
- 状态: 素材已就绪（2026-08-09）；source-book/chapter-cards/ 待 Phase A 生成

## 节目
- 三人对谈（老张/阿凯/阿哲），9 期，35 分钟/期
...
## 硬规则
- voices 有 3 个月保质期，到期刷新（本季 voices 来自 r4/r5 档案的真实书目/网页来源，已带 URL+日期）。
- TTS 是必经站：环境没配好 = BLOCKED，无降级路径。TTS 环境已重建于本机（RTX 5080 16GB + itts310，RTF 1.73-1.89）。
- S3（阿哲）音色 azhe_16k.wav 已入库（2026-08-11，自 m0-m1 引入），三声线齐备。
- 「求职者视角」不适用本季：reviewer 的对应维度为**读者共鸣**（阿哲=没读过拉康的听众代言人）。
