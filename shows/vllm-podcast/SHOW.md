...
- TTS: **IndexTTS-2 定案**（2026-08-08，单句逐 turn 合成）— **已重建恢复**（2026-08-10：itts310 env + 权重 5.5G + 代码仓，smoke test RTF 1.73 通过）。本季音频仍为 2.0 合成；仓库主方案 2026-08-13 已切 IndexTTS-2.5（拉康季先行），见 CLAUDE.md
